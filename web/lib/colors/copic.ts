...
// Source of swatch images: copic-colors.json (root of repo) — generated by build-colors.js,
// already mapping ~131 codes to a Google Drive thumbnail. The rest fall back to hex.
...
export const ALL_COPIC: ColorSwatch[] = Object.values(raw)
  .map(c => ({ code: c.code, hex: c.hex, family: c.family, driveId: c.driveId || null }))
  .sort(sort);
